...
class CloudletDeployment {
    ...
    private fun buildTunnelConfig(
        ...
        interfaceBuilder.setKeyPair(keyPair)
                .parseAddresses(tunnelConfig["address"] as CharSequence)
                .parseDnsServers(tunnelConfig["dns"] as CharSequence)
        ...
        peerBuilder.parsePublicKey(tunnelConfig["publicKey"] as String)
                ...
                .parseAllowedIPs(tunnelConfig["allowedIPs"] as CharSequence)
